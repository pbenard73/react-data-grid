...
type CellKeyDownArgs<TRow, TSummaryRow = unknown> = ActiveCellKeyDownArgs<TRow, TSummaryRow> | EditCellKeyDownArgs<TRow, TSummaryRow>;
...
type ViewportColumnWithColSpan<TRow, TSummaryRow> = [column: CalculatedColumn<TRow, TSummaryRow>, isCellActive: boolean, colSpan: number | undefined];
type IterateOverViewportColumnsForRow<TRow, TSummaryRow> = (activeIdx: number | undefined, args?: ColSpanArgs<TRow, TSummaryRow>) => IteratorObject<ViewportColumnWithColSpan<TRow, TSummaryRow>>;
...
//#endregion
//#region src/hooks/useScrollToPosition.d.ts
...
type SharedDivProps = Pick<React.ComponentProps<'div'>, 'role' | 'aria-label' | 'aria-labelledby' | 'aria-description' | 'aria-describedby' | 'aria-rowcount' | 'className' | 'style' | 'onScroll'>;
 ...
 */
declare function DataGrid<R, SR = unknown, K extends Key = Key>(props: DataGridProps<R, SR, K>): import("react/jsx-runtime").JSX.Element;
//#endregion
...
declare function TreeDataGrid<R, SR = unknown, K extends Key = Key>({
  ...
  ...props
}: TreeDataGridProps<R, SR, K>): import("react/jsx-runtime").JSX.Element;
//#endregion
//#region src/DataGridDefaultRenderersContext.d.ts
declare const DataGridDefaultRenderersContext: import("react").Context<Maybe<Renderers<any, any>>>;
//#endregion
//#region src/Row.d.ts
...
declare function renderCheckbox({
  ...
  indeterminate,
  ...props
}: RenderCheckboxProps): import("react/jsx-runtime").JSX.Element;
//#endregion
//#region src/cellRenderers/renderToggleGroup.d.ts
declare function renderToggleGroup<R, SR>(props: RenderGroupCellProps<R, SR>): import("react/jsx-runtime").JSX.Element;
declare function ToggleGroup<R, SR>({
  groupKey,
  isExpanded,
  tabIndex,
  toggleGroup
}: RenderGroupCellProps<R, SR>): import("react/jsx-runtime").JSX.Element;
//#endregion
//#region src/cellRenderers/renderValue.d.ts
declare function renderValue<R, SR>(props: RenderCellProps<R, SR>): React.ReactNode;
//#endregion
...
}: SelectCellFormatterProps): import("react").ReactNode;
//#endregion
//#region src/editors/renderTextEditor.d.ts
declare function renderTextEditor<TRow, TSummaryRow>({
  row,
  column,
  onRowChange,
  onClose
}: RenderEditCellProps<TRow, TSummaryRow>): import("react/jsx-runtime").JSX.Element;
//#endregion
...
declare function renderHeaderCell<R, SR>({
  ...
  sortDirection,
  priority
}: RenderHeaderCellProps<R, SR>): string | import("react/jsx-runtime").JSX.Element;
//#endregion
//#region src/sortStatus.d.ts
declare function renderSortIcon({
  sortDirection
}: RenderSortIconProps): import("react/jsx-runtime").JSX.Element | null;
declare function renderSortPriority({
  priority
}: RenderSortPriorityProps): number | undefined;
//#endregion
export { type CalculatedColumn, type CalculatedColumnOrColumnGroup, type CalculatedColumnParent, CellComponent as Cell, type CellCopyArgs, type CellKeyDownArgs, type CellKeyboardEvent, type CellMouseArgs, type CellMouseEvent, type CellPasteArgs, type CellRendererProps, type ColSpanArgs, type Column, type ColumnGroup, type ColumnOrColumnGroup, type ColumnWidth, type ColumnWidths, DataGrid, DataGridDefaultRenderersContext, type DataGridHandle, type DataGridProps, type DefaultColumnOptions, type Direction, type FillEvent, type PositionChangeArgs, type RenderCellProps, type RenderCheckboxProps, type RenderEditCellProps, type RenderGroupCellProps, type RenderHeaderCellProps, type RenderRowProps, type RenderSortIconProps, type RenderSortPriorityProps, type RenderSortStatusProps, type RenderSummaryCellProps, type Renderers, RowComponent as Row, type RowHeightArgs, type RowsChangeData, SELECT_COLUMN_KEY, SelectCellFormatter, SelectColumn, type SelectHeaderRowEvent, type SelectRowEvent, type SetActivePositionOptions, type SortColumn, type SortDirection, ToggleGroup, TreeDataGrid, type TreeDataGridProps, renderCheckbox, renderHeaderCell, renderSortIcon, renderSortPriority, renderTextEditor, renderToggleGroup, renderValue, useHeaderRowSelection, useRowSelection };
